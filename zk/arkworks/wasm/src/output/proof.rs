...
// Add after OutputProof struct definition
impl CanonicalSerialize for OutputProof {
...
impl CanonicalDeserialize for OutputProof {
    fn deserialize_with_mode<R: Read>(
        mut reader: R,
        _compress: Compress,
        _validate: Validate,
    ) -> Result<Self, SerializationError> {
        let mut bytes = [0u8; GROTH16_PROOF_LENGTH_BYTES];
